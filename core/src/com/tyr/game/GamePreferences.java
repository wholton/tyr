...
public class GamePreferences {
	...
	private boolean useIntro;
	private static final String USE_INTRO_PREFERENCES_NAME = "USEINTRO";
	...
	public boolean useIntro() {
		return useIntro;
	}

	public void setUseIntro(boolean useIntro) {
	...
	public void loadData() {
		...
		useResizable = preferences.getBoolean(USE_RESIZABLE_PREFERENCES_NAME, false);
		useFullscreen = preferences.getBoolean(USE_FULLSCREEN_PREFERENCES_NAME, true);
		useIntro = preferences.getBoolean(USE_INTRO_PREFERENCES_NAME, true);
	}
	...
	public void saveData() {
		...
		prefs.putBoolean(USE_INTRO_PREFERENCES_NAME, useIntro);

		prefs.flush();
		
		// This is for the pre-app configuation file.
		try {
			// TODO: May want to switch over to XML to make it easier to expand this.
			// Also if users want to change their own prefs files, it's more readable.
			BufferedWriter writer = new BufferedWriter(new FileWriter("Tyr.Preferences"));
